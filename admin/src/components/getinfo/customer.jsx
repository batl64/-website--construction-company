...
export class customer extends Component {
    ...
    onRowDelete = (dat) => {
        respons('delete', '/customer', JSON.stringify(dat))
    }

    onRowUpdate = (dat) => {
        respons('put', '/customer', JSON.stringify(dat))
    }
    ...
    render() {
        ...
        const response = (query) => {
            ...
            const body = {
                ...
                searchFields: ['PIB', 'Region', 'Email', 'Login', 'PhoneNumber', 'City']
            }

            return new Promise((res, rej) => {
                Promise.all([
                    new Promise((res, rej) => {
                        res(respons('get', '/customer?' + new URLSearchParams(body)).then(data => data))
                    }),
                    new Promise((res, rej) => {
                        res(respons('get', '/customerPage').then(data => data))
                    })
                ]).then((data) => {
                    res({
                        data: data[0],
            ...
            <div className="users m-4">
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: translate('region'), field: "Region" },
                        { title: translate('city'), field: "City" },
                    ]}
...
export default withTranslate(customer);