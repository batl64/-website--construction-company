...
export class contractor extends Component {
  ...
  onRowUpdate = (dat) => {
    respons(
      "put",
      "/contractorStatus",
      JSON.stringify({ ...dat, idAdmin: this.props.getState().user.userId })
    );
  };
    ...
    const response = (query) => {
      ...
      return new Promise((res, rej) => {
        Promise.all([
          new Promise((res, rej) => {
            res(
              respons("get", "/contractor?" + new URLSearchParams(body)).then(
                (data) => data
              )
            );
          }),
      ...
      <div className="users m-4">
        <MaterialTable
          ...
          columns={[
            ...
            {
              title: translate("ConfirmationRegistrationAdministrator"),
              field: "ConfirmationRegistrationAdministrator",
              lookup: { 0: translate("notConfirm"), 1: translate("Confirm") },
            },
            {
              title: translate("ConfirmationDateRegistration"),
              field: "ConfirmationDateRegistration",
              editable: "never",
              type: "datetime",
            },
            {
