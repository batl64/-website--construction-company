...
router.get('/getprojectBySearchContractor', ProjectController.getprojectBySearchContractor)
router.get('/getprojectBySearchContractorPage', ProjectController.getprojectBySearchContractorPage)
