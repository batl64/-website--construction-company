    ...
    render() {
        ...
        const responseListWork = (query) => {
            ...
            return new Promise((res, rej) => {
                Promise.all([
                    new Promise((res, rej) => {
                        res(respons('get', '/listconstructionworksProject?' + new URLSearchParams(body)).then(data => data))
                    }),
                    new Promise((res, rej) => {
                        res(respons('get', '/listconstructionworksProjectPage?' + new URLSearchParams(body)).then(data => data))
                    })
                ]).then((data) => {
                    res({
                        data: data[0],
            ...
            <div className="users">
                <div className="m-4">
                    <MaterialTable
                        ...
                        columns={[
                            { title: translate('TypeWork'), field: "TypeWork" },
                            { title: translate('ScopeWork'), field: "ScopeWork" },
                            { title: translate('PlaceConstructionWorks'), field: "PlaceConstructionWorks"},
                            { title: translate('ApproximateConstructionEstimate'), field: "ApproximateConstructionEstimate",  type: 'currency', currencySetting: { currencyCode: 'UAH' } }
                        ]}
