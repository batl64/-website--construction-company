    ...
    render() {
        ...
        const response = (query) => {
            ...
            return new Promise((res, rej) => {
                Promise.all([
                    new Promise((res, rej) => {
                        res(respons('get', '/offeredcontractorsOnCust?' + new URLSearchParams(body)).then(data => data))
                    }),
                    new Promise((res, rej) => {
                        res(respons('get', '/offeredcontractorsPageOnCust?' + new URLSearchParams(body)).then(data => data))
                    })
                ]).then((data) => {
                    res({
                        data: data[0],
